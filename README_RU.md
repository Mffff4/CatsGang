...
## 📜 Описание
**CatsGang Bot** — это автоматизированный бот для игры CatsGang. Поддерживает многопоточность, интеграцию прокси и автоматическое управление игрой.
...
| **CHANNEL_SUBSCRIBE_TASKS** | False                | Подписаться на каналы                                        |
