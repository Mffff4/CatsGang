...
## 📜 Description
**CatsGang Bot** is an automated bot for the CatsGang game. Supports multithreading, proxy integration, and automatic game management.
...
1. **Download the project:**
   ```bash
   git clone https://github.com/Mffff4/CatsGang.git
   cd CatsGang
   ```
...
| **CHANNEL_SUBSCRIBE_TASKS** | False                | Subscribe to channels                                        |
